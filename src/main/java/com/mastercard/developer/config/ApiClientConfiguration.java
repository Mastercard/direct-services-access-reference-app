...
public class ApiClientConfiguration {
  ...
  /**
   * This method generates creates and configures an API client for the Mastercard Direct Services
   * Access API. It loads the .p12 key, correctly sets the base path, and loads other properties
   * for making requests.
   *
